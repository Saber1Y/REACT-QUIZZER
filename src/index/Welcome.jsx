...
const Welcome = () => {
  return (
    <div className='welcome'>
      ...
      <a href="/main" className="bg-green-500 text-white py-2 px-4 rounded-full inline-block hover:bg-green-600">
        Start Quiz
      </a>
      <a href="/rules" className="bg-blue-500 text-white py-2 px-4 rounded-full inline-block hover:bg-blue-600">
        Rules
      </a>
    </div>
  )
